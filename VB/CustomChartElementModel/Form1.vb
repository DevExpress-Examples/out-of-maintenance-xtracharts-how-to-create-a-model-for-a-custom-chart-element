...
Namespace CustomChartElementModel
	Partial Public Class Form1
		...
		Private Sub OnButtonClick(ByVal sender As Object, ByVal e As EventArgs) Handles simpleButton1.Click
			Dim chartDesigner As New ChartDesigner(CType(Me.Controls("MyChart"), ChartControl))
		...
		Public Class SideBySideBarSeriesViewCustomModel
			...
			Public Shadows Property Colorizer() As ChartColorizerBaseModel
				Get
		...
		Public Class CustomPointColorizer
			...
			Public Overrides Function GetAggregatedPointColor(ByVal argument As Object, ByVal values() As Object, ByVal points() As SeriesPoint, ByVal palette As Palette) As Color
				If DirectCast(values(0), Double) > Value Then
		...
		Private Sub Form1_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
			...
			Dim series As New Series("Temperature", ViewType.Bar)
			...
			view.Colorizer = New CustomPointColorizer() With {
				.Value = 60,
		...
		Public Class DataPoint
			...
			Public Shared Function GetDataPoints() As List(Of DataPoint)
				Dim data As New List(Of DataPoint) From {
					New DataPoint(New Date(2019, 6, 1, 0, 0, 0), 56.1226),
					New DataPoint(New Date(2019, 6, 1, 3, 0, 0), 50.18432),
					New DataPoint(New Date(2019, 6, 1, 6, 0, 0), 51.51443),
					New DataPoint(New Date(2019, 6, 1, 9, 0, 0), 60.2624),
					New DataPoint(New Date(2019, 6, 1, 12, 0, 0), 64.04412),
					New DataPoint(New Date(2019, 6, 1, 15, 0, 0), 66.56123),
					New DataPoint(New Date(2019, 6, 1, 18, 0, 0), 65.48127),
					New DataPoint(New Date(2019, 6, 1, 21, 0, 0), 60.4412),
					New DataPoint(New Date(2019, 6, 2, 0, 0, 0), 57.2341),
					New DataPoint(New Date(2019, 6, 2, 3, 0, 0), 52.3469),
					New DataPoint(New Date(2019, 6, 2, 6, 0, 0), 51.82341),
					New DataPoint(New Date(2019, 6, 2, 9, 0, 0), 61.532),
					New DataPoint(New Date(2019, 6, 2, 12, 0, 0), 63.8641),
					New DataPoint(New Date(2019, 6, 2, 15, 0, 0), 65.12374),
					New DataPoint(New Date(2019, 6, 2, 18, 0, 0), 65.6321)
				}
				Return data
			End Function
		End Class
